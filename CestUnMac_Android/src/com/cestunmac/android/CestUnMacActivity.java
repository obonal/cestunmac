...
public class CestUnMacActivity extends SherlockFragmentActivity implements IDataRefreshListener, ILoaderEnabledActivity {
...
//    private boolean         mIsWorking = false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar.Tab tab1 = getSupportActionBar().newTab().setText(getText(R.string.posts_item_tabBarView));
        ActionBar.Tab tab2 = getSupportActionBar().newTab().setText(getText(R.string.categories_item_tabBarView));
        //ActionBar.Tab tab3 = getSupportActionBar().newTab().setText(getText(R.string.wallpapers_item_tabBarView));
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (prog != null) {
                    ...
                    label.setText(working?R.string.loading_post_list_message:R.string.empty_post_list_message);
                }
            }
        });
    }
